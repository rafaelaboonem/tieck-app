import { decideGemini, type GeminiPayload } from "./gemini-gate.ts";

const mockPayload = (overrides: Partial<GeminiPayload>): GeminiPayload => ({
  target_visible: true,
...
const runTest = (name: string, payload: GeminiPayload, options: any) => {
