...
CREATE POLICY "Owners and members can view responses" ON public.checklist_responses
FOR SELECT
USING (
  EXISTS (
    ...
    AND (
      ...
      EXISTS (
        ...
        WHERE wm.workspace_id = c.user_id
...
CREATE POLICY "Owners and members can delete responses" ON public.checklist_responses
FOR DELETE
USING (
  EXISTS (
    SELECT 1 FROM checklists c
